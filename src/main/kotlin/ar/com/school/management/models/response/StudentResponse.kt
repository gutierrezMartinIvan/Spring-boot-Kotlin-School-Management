...
data class StudentResponse(
    ...
    @Schema(title = "The user's surname", example = "Alvarez")
    var surname: String?,

    @Schema(title = "The user's phone number", example = "1212574574")
    var phone: Int?,

    @field:Schema(title = "The user's email", example = "example@gmail.com")
    var email: String?,
